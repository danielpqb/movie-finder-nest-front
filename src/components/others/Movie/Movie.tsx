...
export default function Movie() {
  ...
  return (
    <>
      <div className="movie">
        <div className="data">
          <div className="title">{movie.title || "<Movie Title>"}</div>
